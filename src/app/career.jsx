...
export const CareerSection = () => {
  ...
  return (
    ...
    <div className="flex pt-20 flex-col items-center justify-center bg-green-50">
        ...
        <p className="max-w-[600px] text-center text-xl text-gray-500 mb-7">We're looking for passionate, creative people to join our mission of building amazing products that make a difference in the world.</p>
        ...
        <div className="flex flex-col items-center gap-4 mb-18 md:flex-row">
            ...
            <button className="flex items-center text-sm font-medium rounded-md hover:bg-gray-200 px-7 py-2 border border-gray-300 "> Learn About Our Culture</button>
        </div>
    </div>
    ...
    <div className="flex items-center justify-center flex flex-col mb-12">
        <div className="max-w-[650px] text-center mb-12 mt-12">
          ...
          <p className="text-gray-500">These principles guide everything we do and helps us build a culture where everyone can thrive.</p>
        </div>
        ...
        <div className="flex items-center gap-2 text-center max-w-[360px] border border-gray-200 rounded-lg flex flex-col p-6">
            ...
            <p className="text-gray-500">We believe the best solutions come from diverse perspectives working together towards a commom goal.</p>
        ...
        <div className="flex items-center gap-2 text-center max-w-[360px] border border-gray-200 rounded-lg flex flex-col p-6">
            ...
            <p className="text-gray-500">We strive for excellence in everything we do, continuously learning and improving our craft.</p>
        ...
        <div className="flex items-center gap-2 text-center max-w-[360px] border border-gray-200 rounded-lg flex flex-col p-6">
            ...
            <p className="text-gray-500">We focus on creating meaningful impact for our users, our teams, and the broader community.</p>
    ...
    <div className="flex flex-col items-center justify-center  p-27 gap-6">
        ...
        <p className="text-gray-500 mb-12">Find your next opportunity and join a team that's passionate about making a difference.</p>
        ...
        <div className="flex flex-col w-full p-6 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow duration-200">
            <div className="flex justify-between">
              ...
              <div className="text-xs rounded-lg px-4 py-1 bg-gray-200  font-medium mt-2">Sales</div>
            </div>
            ...
            <p className="text-gray-500 mb-2">Generate and qualify leads to support our sales team in achieving revenue targets.</p>
            ...
            <div className="flex justify-between">
               ...
               <button className="bg-orange-500 rounded-sm text-white px-4 py-1 hover:bg-orange-400">Apply Now</button>
            </div>
        </div>  
        ...
        <div className="flex flex-col w-full p-6 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow duration-200">
            <div className="flex justify-between">
                ...
                <div className="text-xs rounded-lg px-4 py-1 bg-gray-200 font-medium mt-2">Operations</div>
            </div>
            ...
            <p className="text-gray-500 mb-2">Facilitate secure, efficient, and accurate transaction settlements</p>
            <p className="pb-2">Key Requirements:</p>
            <ul className="list-disc list-inside text-gray-500 mb-6 space-y-1">
            ...
            <div className="flex justify-between">
                ...
                <button className="bg-orange-500 hover:bg-orange-400 text-white px-4 py-1 rounded-sm">Apply Now</button>
            </div>
        ...
        <div className="flex flex-col w-full p-6 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow duration-200">
            <div className="flex justify-between">
                ...
                <div className="text-xs rounded-lg px-4 py-1 bg-gray-200 font-medium mt-2">Engineering</div>
            </div>
            <div className="flex gap-4 mb-6">
                <div className="flex items-center  gap-1">
                  <MapPin className="w-4 h-4 text-gray-500" strokeWidth={2}/>
            ...
            <p className="text-gray-500 mb-2">Join our frontend team to build amazing user experience using React, Typescript, and modern web technologies.</p>
            <p className="pb-2">Key Requirements:</p>
            <ul className="list-disc list-inside text-gray-500 mb-6 space-y-1">
        ...
        <div className="flex flex-col w-full p-6 border border-gray-200 rounded-lg hover:shadow-lg transition-shadow duration-200">
            ...
            <p className="text-gray-500 mb-2">Design, develop, and maintain scalable, efficient, and secure APIs</p>
            <p className="pb-2">Key Requirements:</p>
            <ul className="list-disc list-inside text-gray-500 mb-6 space-y-1">
    ...
    <div className="flex flex-col items-center justify-center mb-35 text-center">
        ...
        <p className="text-gray-500 max-w-[650px] mb-4">We believe in taking care of our team members so they can do their best work and enjoy life outside of work too.</p>
        </div>

       <div className="flex items-center justify-center gap-6 pb-6">   {/* might put in padding here */}
           <div className="flex items-center text-center border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[260px]">
              ...
              <p className="text-gray-500">Comprehensive health insurance, dental, and vision coverage for you and your family.</p>
           </div>
           ...
           <div className="flex items-center text-center border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[260px]">
               ...
               <p className="text-gray-500">Generous PTO, paid holidays, and sabbatical opportunities for long-term employees.</p>
           </div>
           ...
           <div className="flex items-center text-center  border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[260px] ">
              ...
              <p className="text-gray-500">Annual learning budget, conference attendance, and internal training programs.</p>
           </div>
           ...
           <div className="flex items-center text-center  border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[260px]">
              ...
              <p className="text-gray-500">Modern offices, free meals, snacks, and premium coffee in all locations.</p>
           </div>
        ...
        <div className="flex items-center justify-center gap-6">
            <div className="border border-gray-200 rounded-lg flex items-center text-center w-[280px] h-[240px] flex flex-col p-6">
                ...
                <p className="text-gray-500">Regular team events, annual company retreats, and social activities.</p>
            </div>
           ...
           <div className="flex items-center text-center  border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[240px]">
              ...
              <p className="text-gray-500">20% time for personal projects and innovation initiatives.</p>
           </div>
           ...
           <div className="flex items-center text-center  border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[240px]">
              ...
              <p className="text-gray-500">Competitive salary, equity options, and comprehensive retirement planning.</p>
           </div>
           ...
           <div className="flex items-center text-center border border-gray-200 rounded-lg flex flex-col p-6 w-[280px] h-[240px]">
              ...
              <p className="text-gray-500">Flexible working hours, and family friendly policies.</p>
           </div>
    ...
    <div className="flex items-center justify-center flex flex-col text-center mb-30">
        ...
        <p className="text-gray-500 max-w-[620px] mb-10">We've designed our hiring process to be transparent, efficient, and focused on finding the right fit for both you and our team.</p>
        ...
        <div className="flex items-center justify-center flex flex-col p-4 ">
           ...
           <p className="text-gray-500 max-w-[270px]">Submit your application and we'll review it within 2 business days.</p>
        </div>
        ...
        <div className="flex items-center justify-center flex flex-col p-4 ">
           ...
           <p className="text-gray-500 max-w-[270px]">Quick 30-minute call to discuss your background and the role.</p>
        </div>
        <div className="flex items-center justify-center flex flex-col p-4 ">
           <div className="w-10 h-10 flex items-center justify-center text-white bg-green-500 rounded-full mb-4">
             3
           ...
           <p className="text-gray-500 max-w-[270px]">Deep dive into your skills with relevant team members.</p>
        </div>
        <div className="flex items-center justify-center flex flex-col p-4 ">
           <div className="w-10 h-10 flex items-center justify-center text-white bg-green-500 rounded-full mb-4">
             4
           ...
           <p className="text-gray-500 max-w-[270px]">Meet the team and leadership to ensure cultural fit.</p>
        </div>
        </div>
    </div>
    ...
    <div className="flex items-center flex flex-col mb-20 gap-3">
        ...
        <p className="text-gray-500 max-w-[630px] text-center mb-12">Don't see the perfect role? Have questions about our company or culture? We'de love to hear from you.</p>
        ...
        <div className="flex items-center border border-gray-200 rounded-lg p-6 pt-6 w-[460px] h-[130px]">
            <div className="flex items center gap-3 ">
               ...
               <div className="flex flex-col">
                 ...
                 <p className="text-gray-500 mb-2"><a href="helpdesk@globalpayng.com">helpdesk@globalpayng.com</a></p>
               </div>
            </div>
        </div> 
        ...
        <div className="flex items-center border border-gray-200 rounded-lg p-6 pt-6 w-[460px] h-[130px]">
            <div className="flex items center gap-3 ">
               ...
               <div className="flex flex-col">
                 ...
                 <p className="text-gray-500 mb-2">5A Sogunle Street, Ikeja, Lagos Nigeria</p>
               </div>
            </div>
        </div>
    </div>
